...
int start_posx=180;       //start position  x axis
int start_posy=210;
int collisionx1=0;
int collisionx2=0;
int collisiony1=0;
int collisiony2=0;
int fre1[6]={258,300,320,240,290,400};      //music frequency
int duration1[6]={150,180,120,150,130,200};   // sound duration
int flagx;
int flagy;
...
void start_game(){
const code char car_jpg[1051] = {  //car jpg art value in pixels
...
///ADC Configuration for speed control of the car
